...
func (x *CommodityFilterReq) GetBrand() int32 {
	if x != nil {
		return x.Brand
	}
	return 0
...
type CommodityInfoRes struct {
	...
	FrontImage []string `protobuf:"bytes,15,rep,name=frontImage,proto3" json:"frontImage,omitempty"`
...
type CreateCommodityReq struct {
	...
	Images          []string `protobuf:"bytes,13,rep,name=images,proto3" json:"images,omitempty"`
	DescImages      []string `protobuf:"bytes,14,rep,name=descImages,proto3" json:"descImages,omitempty"`
	GoodsFrontImage []string `protobuf:"bytes,15,rep,name=goodsFrontImage,proto3" json:"goodsFrontImage,omitempty"`
...
var file_commodity_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x62, 0x72, 0x61, 0x6e, 0x64, 0x12, 0x10, 0x0a, 0x03, 0x6b,
	...
	0x72, 0x6f, 0x6e, 0x74, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x09, 0x52,
	...
	0x6e, 0x74, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0f, 0x67,
